export class CodingInstructionsManager {
  ...
  public getGenerationRules(): string[] {
    return [
      ...
      'When existing source code is provided in RELEVANT EXISTING SOURCE FILES, perform incremental edits, extensions, or modifications directly on that code.',
      'PRESERVE all pre-existing code, HTML structures, imports, and functions unless the user explicitly requests to delete them.',
      'Never overwrite or discard existing code with empty or generic replacement code.',
