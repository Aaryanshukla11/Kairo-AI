...
export class CompatibilityReport {
  public generate(workspaceRoot: string): string {
    const reportContent = `# Kairo-AI Compatibility Report
...
`;
    ...
    fs.writeFileSync(path.join(workspaceRoot, 'RC1_COMPATIBILITY_REPORT.md'), reportContent);
    return reportContent;
  }
}

export const compatibilityReport = new CompatibilityReport();
